...
9. Try Command Center commands such as `只看深圳 Go 后端，刷新任务`, `run crawl`, or `发送飞书日报`.
10. Use Send to Feishu from the duty report when you want the assistant to push the current task queue and summary to your bot.
