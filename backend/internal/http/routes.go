...
func NewRouter(handlers *Handlers) http.Handler {
	...
	api.GET("/agent/cycles", handlers.ListAgentCycles)
	api.POST("/agent/cycles/run", handlers.RunAgentCycle)
	api.GET("/agent/tools", handlers.ListAgentTools)
	...
	api.GET("/agent/chat/config", handlers.GetAgentChatConfig)
	api.PATCH("/agent/chat/config", handlers.UpdateAgentChatConfig)
	...
	api.GET("/agent/onboarding/health", handlers.GetOnboardingHealth)
